...
module.exports = {
  ...
  nomesPopulares: t('Caso este serviço seja conhecido por um ou mais nomes populares, liste-os nos campos abaixo.'),
  ...
  solicitantes: t('Descreva quem pode utilizar este serviço e quais requisitos devem ser cumpridos pelos mesmos.'),
  ...
  orgaoResponsavel: t('Selecione o órgão responsável por este serviço.'),
