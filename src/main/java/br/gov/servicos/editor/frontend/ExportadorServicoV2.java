...
public class ExportadorServicoV2 {
    ...
    public Document exportar(Servico servico) {
        ...
        Element root = document
                ...
                .attr("versao", "2")
                .attr("xmlns", "http://servicos.gov.br/cartas-servico/v2/schema/servico")
                .attr("xmlns:xsi", "http://www.w3.org/2001/XMLSchema-instance")
                .attr("xsi:schemaLocation", "http://servicos.gov.br/cartas-servico/v2/schema/servico ../servico.xsd")
