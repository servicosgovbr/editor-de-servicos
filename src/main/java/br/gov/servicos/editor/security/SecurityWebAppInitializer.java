...
public class SecurityWebAppInitializer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(POST, API_PAGINA_TEMATICA).hasAnyAuthority(SALVAR_EDITAR.comTipoPagina(PAGINA_TEMATICA),
                ...
                .antMatchers(POST, API_PAGINA).hasAnyAuthority(SALVAR_EDITAR.getNome(), PUBLICAR.getNome(), DESPUBLICAR.getNome())
