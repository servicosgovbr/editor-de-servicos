...
public class TestData {
    ...
    public static final Servico SERVICO_V1 = new Servico()
            ...
            .withEtapas(singletonList(new Etapa()
                    ...
                    .withCanaisDePrestacao(asList(
                            new CanalDePrestacao().withTipo("Web").withTitulo("").withReferencia("http://www.dpf.gov.br/servicos/passaporte/requerer-passaporte").withPreferencial(true),
                            new CanalDePrestacao().withTipo("Agendamento").withTitulo("").withReferencia("")
                    ))))
    ...
    public static final Servico SERVICO_V2 = new Servico()
            ...
            .withEtapas(singletonList(new Etapa()
                            ...
                            .withCanaisDePrestacao(asList(
                                    new CanalDePrestacao().withTitulo("").withReferencia("Posto de atendimento").withPreferencial(true).withTipo("Presencial"),
                                    new CanalDePrestacao().withTitulo("").withReferencia("555").withPreferencial(false).withTipo("Telefone")
                            ))
            ))
